                ...
                <div class="product-details-p-1">
                    ...
                    <div class="pricing">
                        ...
                        <span v-if="showComparePrice && effectiveComparePrice > selectedVariantPrice" class="discount">
                            -{{ product?.active_campaign?.discount_type === 'fixed' ? `${currency}${product?.active_campaign?.discount_value}` : `${Math.round(((effectiveComparePrice - selectedVariantPrice) / effectiveComparePrice) * 100)}%` }}
                        </span>
                    </div>
