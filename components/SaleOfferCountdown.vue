                ...
                <div class="carousel-card">
                    <NuxtLink :to="`/products/${item.category?.slug}/${item.slug}`" class="carousel-link">
                        ...
                        <div class="carousel-price-section">
                            ...
                            <p class="carousel-current-price">{{ getCurrentPriceDisplay(item) }}</p>
...
// Current price display (single or range if variant prices differ)
const getCurrentPriceDisplay = (product: HomePageProduct2): string => {
