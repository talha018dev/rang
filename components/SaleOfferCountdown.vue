                ...
                <div class="carousel-card">
                    <NuxtLink :to="`/products/${item.slug}`" class="carousel-link">
                        ...
                        <div class="carousel-price-section">
                            <p v-if="item.compare_price > item.price" class="carousel-old-price">{{ item.compare_price.toLocaleString() }}<span class="carousel-old-price-currency">৳</span></p>
                            <div class="carousel-price-row">
                                <p class="carousel-current-price">{{ item.price.toLocaleString() }}<span class="carousel-current-price-currency">৳</span></p>
