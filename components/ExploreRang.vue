            ...
            <div class="explore-grid-main">
                <NuxtLink to="/products/family">
                    <div class="image-div explore-grid-main-image">
                        <img src="/explore/explore-1.png" alt="Explore Rang" class="category-image-rounded"
                            style="height: 100%;" />
